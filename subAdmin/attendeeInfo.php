...
<body>
    <div class="main">
        ...
        <div class="container123">
            ...
            <a href="#" id="viewProofButton" style="color: #dc3545;;">View Certificates</a>
            <div id="proofModal" class="modal">
                <div class="modal-content">
                    <span class="close" id="closeProofModal" style="color: #fff;">&times;</span>
                    <h3>Certificates</h3>
                    <table>
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th>Event Certificates</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="withcert">
