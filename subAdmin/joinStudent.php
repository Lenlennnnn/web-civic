        ...
        <div class="container py-5">
            <div class="row">
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        <tr class="clickable-row" onclick="window.location.href='entrantInfo1.php';">
                            <td>Cruz, Juan D.</td>
                            <td>20-12345</td>
                            <td>Male</td>
                        ...
                        <tr class="clickable-row" onclick="window.location.href='entrantInfo2.php';">
                            <td>Draguin, Sam C.</td>
                            <td>20-54321</td>
                            <td>Male</td>
                            <td>Civic Welfare Traing Service</td>
